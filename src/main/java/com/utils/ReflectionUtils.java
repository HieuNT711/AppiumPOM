...
public class ReflectionUtils {
    ...
    public static Map<String, Object> serializeObjectToMap(Object instance) {
        try {
            ...
            throw new RuntimeException("Error to serialize object to map", var7);
        }
    }

    private static void convertObjectFieldToJsonMap(
            Object fieldValue, Field field, Map<String, Object> fieldMap) {
    ...
    private static void addListObjectToJsonMap(
            Object value,
            SerializedName serializedName,
    ...
    private static void validateDuplicateKeyName(Map<String, Object> fieldMap, String keyName) {
        if (fieldMap.containsKey(keyName)) {
            throw new RuntimeException(
                    String.format(
                            "Key [%s] existing in DTO, please verify @SerializedName in your DTO"
                                    + " class",
                            keyName));
        }
    }
