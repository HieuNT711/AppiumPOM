...
//                getText = getText(By.xpath(String.format(XPATH_LABEL_BY_TEXT, text)), "Get text of: " + text);
//            } else {
//                getText = getText(By.xpath(String.format(XPATH_BY_TEXT_ANDROID, text)), "Get text of: " + text);
//            }
...
//        Assert.assertTrue(RegexUtils.isPatternMatched(pattern, getText(By.xpath(pattern), "Get text")), "Qr text not match");
//    }
}
